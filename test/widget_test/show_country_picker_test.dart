...
void main() => group('showCountryPicker -', () {
      testWidgets('displays bottom sheet with country list view',
          (tester) async {
        ...
        expect(find.byType(CountriesListView), findsOneWidget);
      });
      ...
      testWidgets('calls onDone callback when picker is dismissed',
          (tester) async {
