...
void main() => group('CountryPhoneInput -', () {
  group('initialization -', () {
    ...
    testWidgets('should display the initial country provided', (tester) async {
  ...
  group('interaction -', () {
    testWidgets('should open country picker when country code area is tapped', (
      tester,
    ) async {
      await tester.pumpWidget(
        WidgetTestHelper.createWidgetUnderTest(
  ...
  group('formatting -', () {
    testWidgets('should apply country mask to input phone number', (
      ...
      expect(
        find.text('12 34 56 78'),
        findsOneWidget,
      ); // Formatted according to the country mask
    });
  });
