...
class CountryScope extends StatefulWidget {
  ...
  static CountryController of(BuildContext context, {bool listen = false}) =>
  ...
  /// that encloses the given context, if any.
  /// e.g. `CountryScope.getByCountryCode(context, countryCode)`.
  static Country? getByCountryCode(
    ...
    context,
    listen: listen,
  ).state.getByCountryCode(countryCode);
...
class _CountriesScopeState extends State<CountryScope> {
  ...
  @override
  Widget build(BuildContext context) => ValueListenableBuilder<CountryState>(
...
class _InheritedCountries extends InheritedModel<String> {
  ...
  static _InheritedCountries of(BuildContext context, {bool listen = true}) =>
